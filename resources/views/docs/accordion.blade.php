<x-layouts.app title="Accordion - Flowbite Blade">
    <h1 class="mb-4 text-3xl font-bold text-gray-900 dark:text-white">Accordion</h1>
...
<x-fwb.accordion id="default-accordion">
    <x-fwb.accordion.item id="item-1" :open="true">
        <x-slot:title>What is Flowbite?</x-slot:title>
    ...
    <x-fwb.accordion.item id="item-2">
        <x-slot:title>Is there a Figma file available?</x-slot:title>
        <p class="mb-2 text-gray-500 dark:text-gray-400">Flowbite is first conceptualized and designed using the Figma software so everything you see in the library has a design equivalent in our Figma file.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="item-3">
        <x-slot:title>What are the differences between Flowbite and Tailwind UI?</x-slot:title>
...
<x-fwb.accordion id="always-open-accordion" :alwaysOpen="true">
    <x-fwb.accordion.item id="ao-1" :open="true">
        <x-slot:title>What is Flowbite?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is an open-source library of interactive components built on top of Tailwind CSS.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="ao-2" :open="true">
        <x-slot:title>Is there a Figma file available?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is first conceptualized and designed using the Figma software.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="ao-3">
        <x-slot:title>What are the differences between Flowbite and Tailwind UI?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">The main difference is that the core components from Flowbite are open source under the MIT license.</p>
    </x-fwb.accordion.item>
</x-fwb.accordion>
BLADE;
    @endphp
...
<x-fwb.accordion id="separated-accordion" :separated="true">
    <x-fwb.accordion.item id="sep-1" :open="true">
        <x-slot:title>What is Flowbite?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is an open-source library of interactive components built on top of Tailwind CSS.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="sep-2">
        <x-slot:title>Is there a Figma file available?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is first conceptualized and designed using the Figma software.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="sep-3">
        <x-slot:title>What are the differences between Flowbite and Tailwind UI?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">The main difference is that the core components from Flowbite are open source under the MIT license.</p>
    </x-fwb.accordion.item>
</x-fwb.accordion>
...
<x-fwb.accordion id="flush-accordion" :flush="true">
    <x-fwb.accordion.item id="flush-1" :open="true">
        <x-slot:title>What is Flowbite?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is an open-source library of interactive components built on top of Tailwind CSS.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="flush-2">
        <x-slot:title>Is there a Figma file available?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is first conceptualized and designed using the Figma software.</p>
    </x-fwb.accordion.item>
</x-fwb.accordion>
...
<x-fwb.accordion id="color-accordion" activeClasses="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white" inactiveClasses="text-gray-500 dark:text-gray-400">
    <x-fwb.accordion.item id="color-1" :open="true">
        <x-slot:title>What is Flowbite?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is an open-source library of interactive components built on top of Tailwind CSS.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="color-2">
        <x-slot:title>Is there a Figma file available?</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">Flowbite is first conceptualized and designed using the Figma software.</p>
    </x-fwb.accordion.item>
</x-fwb.accordion>
...
<x-fwb.accordion id="arrow-accordion">
    <x-fwb.accordion.item id="arrow-1" arrowStyle="none" :open="true">
        <x-slot:title>No arrow icon</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">This accordion item has no arrow indicator.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="arrow-2" arrowStyle="static">
        <x-slot:title>Static arrow (no rotation)</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">This accordion item has an arrow that does not rotate on open/close.</p>
    </x-fwb.accordion.item>
    <x-fwb.accordion.item id="arrow-3" arrowStyle="default">
        <x-slot:title>Rotating arrow (default)</x-slot:title>
        <p class="text-gray-500 dark:text-gray-400">This accordion item has the default rotating arrow indicator.</p>
    </x-fwb.accordion.item>
</x-fwb.accordion>
BLADE;
    @endphp
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">Named slot for the accordion item heading text.</td>
                    </tr>
                </tbody>
            </table>
        </div>
