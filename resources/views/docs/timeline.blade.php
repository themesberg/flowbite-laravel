<x-layouts.app title="Timeline - Flowbite Blade">
    <h1 class="mb-4 text-3xl font-bold text-gray-900 dark:text-white">Timeline</h1>
...
BLADE;
    ...
    $code = <<<'BLADE'
<x-fwb.timeline>
    <x-fwb.timeline.item title="Flowbite Application UI v2.0.0" date="Released on January 13th, 2022">
        <x-slot:icon>
    ...
    <x-fwb.timeline.item title="Flowbite Figma v1.3.0" date="Released on December 7th, 2021">
        <x-slot:icon>
            <svg class="w-2.5 h-2.5 text-blue-800 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/></svg>
        </x-slot:icon>
        All of the pages and components are first designed in Figma and we keep a parity between the two versions even as we update the project.
    </x-fwb.timeline.item>
    <x-fwb.timeline.item title="Flowbite Library v1.2.2" date="Released on December 2nd, 2021">
        <x-slot:icon>
            <svg class="w-2.5 h-2.5 text-blue-800 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/></svg>
        </x-slot:icon>
        Get started with dozens of web components and interactive elements built on top of Tailwind CSS.
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">Named slot for a custom icon in the timeline dot area.</td>
                    </tr>
                </tbody>
            </table>
        </div>
