<x-layouts.app title="Toggle - Flowbite Blade" description="Use the toggle component to switch between two states such as on/off or enabled/disabled, with support for sizes, colors, and disabled state.">
