<x-layouts.app title="Pricing Card - Flowbite Blade" description="Use the pricing card component to display pricing plans with a title, price, features list, and call-to-action button.">
