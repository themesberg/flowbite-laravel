<x-layouts.app title="Table - Flowbite Blade" description="Use the table component to show data in a structured tabular format with support for striped rows, hover states, and more.">
